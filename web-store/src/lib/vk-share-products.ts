...
const products: VkShareProduct[] = [
  ...
  },
  {
    ...
    description:
      "Инверторный стабилизатор 3000 ВА / 2500 Вт. При полной нагрузке работает при входном напряжении 165–310 В; предельный диапазон 90–310 В доступен со снижением мощности.",
    imageUrl: "/static/cf-cards/shtil-is3000rt.png",
    price: "36 300 ₽",
    highlights: [
      "Полная мощность 3000 ВА",
      "Активная мощность 2500 Вт",
      "Вход 165–310 В при 100% нагрузке",
      "Предельный диапазон 90–310 В со снижением мощности",
  ...
  },
  {
    ...
    description:
      "Настенный ступенчатый стабилизатор 2000 ВА с рабочим диапазоном входного напряжения 140–260 В и расширенным диапазоном 125–270 В.",
    imageUrl: "/static/cf-cards/powerman-avs-2000s.png",
    price: "5 950 ₽",
    highlights: [
      "Полная мощность 2000 ВА",
      "Рабочий диапазон входного напряжения 140–260 В",
      "Расширенный диапазон входного напряжения 125–270 В",
