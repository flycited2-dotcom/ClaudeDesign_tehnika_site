(function () {
  ...
  const clients = [
    ...
    { id: 'CL-0003', name: 'ГБУЗ ГКБ №67',               type: 'state',      inn: '7709876543',   kpp: '770901001', legalAddress: 'г. Москва, ул. Садовая, 12', factAddress: 'г. Москва, ул. Садовая, 12', phone: '+7 495 200-03-03', email: 'gkb67@mos.ru',         source: 'Парсинг тендеров', responsible: 'USR-007', status: 'active',   segment: 'Тендеры', tags: ['гос','тендер'],            dealsSum: 5600000, lastActivity: day(-2),  createdAt: day(-365) },
    { id: 'CL-0004', name: 'ИП Корнилова О.А.',           type: 'individual', inn: '501234567890', kpp: null,        legalAddress: 'г. Краснодар, ул. Красная, 88', factAddress: 'г. Краснодар, ул. Красная, 88', phone: '+7 861 200-04-04', email: 'kornilova@mail.ru',    source: 'splihome.ru',           responsible: 'USR-005', status: 'prospect', segment: 'Розница', tags: ['новый'],                   dealsSum: 0,       lastActivity: day(-10), createdAt: day(-30)  },
    ...
    { id: 'CL-0006', name: 'ООО Балтэнерго',              type: 'company',    inn: '7801122334',   kpp: '780101001', legalAddress: 'г. Санкт-Петербург, пр. Невский, 100', factAddress: 'г. Санкт-Петербург, пр. Невский, 100', phone: '+7 812 200-06-06', email: 'balt@baltenergo.ru',   source: 'Приложение SplitHub',       responsible: 'USR-004', status: 'active',   segment: 'Опт',     tags: ['энергетика','опт'],        dealsSum: 1750000, lastActivity: day(-1),  createdAt: day(-150) },
    { id: 'CL-0007', name: 'ТОО МедТехника Плюс',         type: 'company',    inn: '7703344556',   kpp: '770301001', legalAddress: 'г. Москва, ул. Профсоюзная, 33', factAddress: 'г. Москва, ул. Профсоюзная, 33', phone: '+7 495 200-07-07', email: 'med@medtech.ru',       source: 'splihub.ru',      responsible: 'USR-006', status: 'active',   segment: 'Тендеры', tags: ['медицина','тендер'],        dealsSum: 890000,  lastActivity: day(-7),  createdAt: day(-200) },
    ...
    { id: 'CL-0009', name: 'ООО НефтехимСнаб',            type: 'company',    inn: '7727556677',   kpp: '772701001', legalAddress: 'г. Москва, Варшавское ш., 9', factAddress: 'г. Москва, Варшавское ш., 9', phone: '+7 495 200-09-09', email: 'ncs@nchsnab.ru',       source: 'splihome.ru',           responsible: 'USR-004', status: 'active',   segment: 'Опт',     tags: ['химия','опт'],             dealsSum: 3100000, lastActivity: day(-2),  createdAt: day(-400) },
    { id: 'CL-0010', name: 'МБОУ СОШ №15 г. Тулы',       type: 'state',      inn: '7101667788',   kpp: '710101001', legalAddress: 'г. Тула, ул. Первомайская, 15', factAddress: 'г. Тула, ул. Первомайская, 15', phone: '+7 487 200-10-10', email: 'school15@tula.edu',    source: 'Парсинг тендеров', responsible: 'USR-007', status: 'prospect', segment: 'Тендеры', tags: ['гос','образование'],        dealsSum: 120000,  lastActivity: day(-14), createdAt: day(-45)  },
    { id: 'CL-0011', name: 'ИП Семёнов В.Г.',             type: 'individual', inn: '772377889900', kpp: null,        legalAddress: 'г. Москва, ул. Арбат, 10', factAddress: 'г. Москва, ул. Арбат, 10', phone: '+7 495 200-11-11', email: 'semenov@yandex.ru',    source: 'Авито',       responsible: 'USR-006', status: 'inactive', segment: 'Розница', tags: ['малый бизнес'],            dealsSum: 480000,  lastActivity: day(-60), createdAt: day(-500) },
    { id: 'CL-0012', name: 'ООО Техностандарт',           type: 'company',    inn: '5047889900',   kpp: '504701001', legalAddress: 'г. Мытищи, ул. Промышленная, 7', factAddress: 'г. Мытищи, ул. Промышленная, 7', phone: '+7 495 200-12-12', email: 'info@techstandard.ru', source: 'splihub.ru',      responsible: 'USR-003', status: 'active',   segment: 'Опт',     tags: ['оборудование','опт'],      dealsSum: 1900000, lastActivity: day(-3),  createdAt: day(-190) },
    { id: 'CL-0013', name: 'ГКУ Центр занятости Москвы',  type: 'state',      inn: '7723990011',   kpp: '772301001', legalAddress: 'г. Москва, ул. Тверская, 50', factAddress: 'г. Москва, ул. Тверская, 50', phone: '+7 495 200-13-13', email: 'czm@mos.ru',           source: 'Парсинг тендеров', responsible: 'USR-007', status: 'active',   segment: 'Тендеры', tags: ['гос','тендер'],            dealsSum: 780000,  lastActivity: day(-6),  createdAt: day(-280) },
    ...
    { id: 'CL-0015', name: 'ПАО Газснабсервис',           type: 'company',    inn: '7736111223',   kpp: '773601001', legalAddress: 'г. Москва, Ленинградский пр., 80', factAddress: 'г. Москва, Ленинградский пр., 80', phone: '+7 495 200-15-15', email: 'gss@gazsnab.ru',       source: 'splihome.ru',           responsible: 'USR-004', status: 'active',   segment: 'Опт',     tags: ['газ','опт','ключевой'],    dealsSum: 6100000, lastActivity: day(-1),  createdAt: day(-600) },
    { id: 'CL-0016', name: 'ИП Луговой Р.Н.',             type: 'individual', inn: '500911223344', kpp: null,        legalAddress: 'г. Казань, ул. Баумана, 5', factAddress: 'г. Казань, ул. Баумана, 5', phone: '+7 843 200-16-16', email: 'lugovoi@gmail.com',    source: 'splihub.ru',      responsible: 'USR-006', status: 'prospect', segment: 'Розница', tags: ['новый'],                   dealsSum: 0,       lastActivity: day(-20), createdAt: day(-20)  },
    ...
    { id: 'CL-0018', name: 'ООО Экотранспорт',            type: 'company',    inn: '7801334556',   kpp: '780101002', legalAddress: 'г. Санкт-Петербург, ул. Заставская, 14', factAddress: 'г. Санкт-Петербург, ул. Заставская, 14', phone: '+7 812 200-18-18', email: 'eco@ecotrans.ru',      source: 'Приложение SplitHub',       responsible: 'USR-005', status: 'active',   segment: 'Опт',     tags: ['транспорт','опт'],         dealsSum: 970000,  lastActivity: day(-4),  createdAt: day(-170) },
    { id: 'CL-0019', name: 'ФГУП НИИ Технологий',         type: 'state',      inn: '7702445667',   kpp: '770201001', legalAddress: 'г. Москва, ул. Академика Королёва, 3', factAddress: 'г. Москва, ул. Академика Королёва, 3', phone: '+7 495 200-19-19', email: 'niit@niit.ru',         source: 'Парсинг тендеров', responsible: 'USR-007', status: 'active',   segment: 'Тендеры', tags: ['гос','наука'],             dealsSum: 3400000, lastActivity: day(-3),  createdAt: day(-450) },
    { id: 'CL-0020', name: 'ООО РусХолод',                type: 'company',    inn: '5027556778',   kpp: '502701001', legalAddress: 'г. Красногорск, ул. Речная, 3', factAddress: 'г. Красногорск, ул. Речная, 3', phone: '+7 495 200-20-20', email: 'info@rusholod.ru',     source: 'splihome.ru',           responsible: 'USR-004', status: 'active',   segment: 'Опт',     tags: ['холодильное'],             dealsSum: 1620000, lastActivity: day(-5),  createdAt: day(-130) },
    { id: 'CL-0021', name: 'ИП Петрова М.С.',             type: 'individual', inn: '771156778901', kpp: null,        legalAddress: 'г. Москва, ул. Митинская, 22', factAddress: 'г. Москва, ул. Митинская, 22', phone: '+7 495 200-21-21', email: 'petrova.ms@inbox.ru',  source: 'Авито',       responsible: 'USR-006', status: 'prospect', segment: 'Розница', tags: ['новый','розница'],         dealsSum: 0,       lastActivity: day(-5),  createdAt: day(-15)  },
    { id: 'CL-0022', name: 'ООО ТехноПром',               type: 'company',    inn: '7710667889',   kpp: '771001001', legalAddress: 'г. Москва, Каширское ш., 17', factAddress: 'г. Москва, Каширское ш., 17', phone: '+7 495 200-22-22', email: 'tp@technoprom.ru',     source: 'splihub.ru',      responsible: 'USR-003', status: 'inactive', segment: 'Опт',     tags: ['приостановлен'],           dealsSum: 560000,  lastActivity: day(-90), createdAt: day(-700) },
    { id: 'CL-0023', name: 'ГАУ Спортивная школа №3',     type: 'state',      inn: '7707778900',   kpp: '770701001', legalAddress: 'г. Москва, ул. Беговая, 7', factAddress: 'г. Москва, ул. Беговая, 7', phone: '+7 495 200-23-23', email: 'sport3@mos.ru',        source: 'Парсинг тендеров', responsible: 'USR-007', status: 'prospect', segment: 'Тендеры', tags: ['гос','спорт'],             dealsSum: 0,       lastActivity: day(-12), createdAt: day(-25)  },
  ...
  const leads = [
    { id: 'LD-0001', title: 'Поставка насосного оборудования',      source: 'splihub.ru',              status: 'new',       responsible: null,      createdAt: min(-25), clientCandidate: 'ООО РусНасос',           phone: '+7 495 400-01-01', email: 'info@rusnasoc.ru',   sum: 350000,  utm: { source: 'google', medium: 'cpc', campaign: 'pumps-2026' } },
    { id: 'LD-0002', title: 'Запрос на оптовую поставку СИЗ',       source: 'splihome.ru',                   status: 'new',       responsible: null,      createdAt: min(-47), clientCandidate: 'ИП Дроздов А.В.',        phone: '+7 903 400-02-02', email: 'drozdov.av@mail.ru', sum: null,    utm: { source: 'yandex', medium: 'cpc', campaign: 'opt-siz' } },
    { id: 'LD-0003', title: 'Тендер на поставку медикаментов',       source: 'Парсинг тендеров', status: 'new',       responsible: null,      createdAt: min(-72), clientCandidate: 'ГБУЗ Клиника №5',        phone: '+7 495 400-03-03', email: 'zakup@klinika5.ru',  sum: 870000,  utm: { source: 'zakupki', medium: 'tender', campaign: null } },
    ...
    { id: 'LD-0005', title: 'Интерес к поставке холодильников',      source: 'Авито',                      status: 'in_work',   responsible: 'USR-004', createdAt: day(-3),  clientCandidate: 'ТД Морозко',             phone: '+7 812 400-05-05', email: 'info@morozko.ru',    sum: 180000,  utm: { source: 'avito', medium: 'message', campaign: null } },
    { id: 'LD-0006', title: 'Оптовый заказ метизов',                 source: 'splihome.ru',                   status: 'in_work',   responsible: 'USR-005', createdAt: day(-1),  clientCandidate: 'ООО МеталлТрейд',        phone: '+7 343 400-06-06', email: 'metal@mttrade.ru',   sum: 95000,   utm: { source: 'yandex', medium: 'organic', campaign: null } },
    { id: 'LD-0007', title: 'Поставка офисной мебели по тендеру',    source: 'Парсинг тендеров', status: 'qualified', responsible: 'USR-007', createdAt: day(-5),  clientCandidate: 'МКУ Администрация р-на', phone: '+7 495 400-07-07', email: 'mku@admin.ru',       sum: 630000,  utm: { source: 'zakupki', medium: 'tender', campaign: null } },
    { id: 'LD-0008', title: 'Реализация спецодежды',                 source: 'splihub.ru',              status: 'qualified', responsible: 'USR-003', createdAt: day(-4),  clientCandidate: 'ООО ЗащитаТруд',         phone: '+7 846 400-08-08', email: 'info@zaschitrud.ru', sum: 210000,  utm: { source: 'google', medium: 'cpc', campaign: 'clothing' } },
    ...
    { id: 'LD-0010', title: 'Поставка химических реактивов',         source: 'splihome.ru',                   status: 'qualified', responsible: 'USR-004', createdAt: day(-7),  clientCandidate: 'НПО ХимСинтез',          phone: '+7 495 400-10-10', email: 'khim@npohim.ru',     sum: 475000,  utm: { source: 'yandex', medium: 'cpc', campaign: 'chem-2026' } },
    { id: 'LD-0011', title: 'Поставка запчастей для спецтехники',    source: 'Приложение SplitHub',        status: 'in_work',   responsible: 'USR-005', createdAt: day(-2),  clientCandidate: 'ООО АвтоСпецТехника',    phone: '+7 343 400-11-11', email: 'ast@ast-ural.ru',    sum: 320000,  utm: { source: 'app', medium: 'mobile', campaign: null } },
    { id: 'LD-0012', title: 'Запрос на поставку кабельной продукции', source: 'climat-simf.ru',             status: 'in_work',   responsible: 'USR-006', createdAt: day(-1),  clientCandidate: 'ООО ЭлектроМонтаж',      phone: '+7 495 400-12-12', email: 'em@electromontaj.ru', sum: 560000, utm: { source: 'google', medium: 'organic', campaign: null } },
    ...
    { id: 'LD-0014', title: 'Поставка стройматериалов для дачи',     source: 'Авито',                      status: 'rejected',  responsible: 'USR-004', createdAt: day(-8),  clientCandidate: 'Физлицо Щукин И.О.',     phone: '+7 916 400-14-14', email: 'shchukin@mail.ru',   sum: 15000,   utm: { source: 'avito', medium: 'message', campaign: null } },
    { id: 'LD-0015', title: 'Тендер: медоборудование для поликлиники',source: 'Парсинг тендеров',status: 'qualified', responsible: 'USR-007', createdAt: day(-9),  clientCandidate: 'ГБУЗ Поликлиника №102', phone: '+7 495 400-15-15', email: 'zakup@pk102.ru',     sum: 1200000, utm: { source: 'zakupki', medium: 'tender', campaign: null } },
    { id: 'LD-0016', title: 'Запрос КП: складское оборудование',     source: 'splihome.ru',                   status: 'in_work',   responsible: 'USR-005', createdAt: day(-3),  clientCandidate: 'ООО ЛогистикПро',        phone: '+7 495 400-16-16', email: 'log@logpro.ru',      sum: 780000,  utm: { source: 'yandex', medium: 'cpc', campaign: 'sklad' } },
    { id: 'LD-0017', title: 'Поставка инвентаря для школьного спорт. зала', source: 'Парсинг тендеров', status: 'qualified', responsible: 'USR-007', createdAt: day(-11), clientCandidate: 'МБОУ СОШ №31',    phone: '+7 487 400-17-17', email: 'school31@tula.edu',  sum: 95000,   utm: { source: 'zakupki', medium: 'tender', campaign: null } },
    { id: 'LD-0018', title: 'Поставка канцтоваров для офиса',        source: 'splihub.ru',              status: 'rejected',  responsible: 'USR-006', createdAt: day(-15), clientCandidate: 'ООО СервисОфис',         phone: '+7 495 400-18-18', email: 'soffice@serv.ru',    sum: 28000,   utm: { source: 'google', medium: 'cpc', campaign: 'office' } },
  ];
  ...
  const notifications = [
    ...
    { id: 'NTF-002', type: 'lead.created',        title: 'Новый лид с сайта splihome.ru',         body: 'Получен запрос на оптовую поставку СИЗ от ИП Дроздов А.В. — без ответственного.', createdAt: min(-47), readAt: null,     severity: 'warning' },
