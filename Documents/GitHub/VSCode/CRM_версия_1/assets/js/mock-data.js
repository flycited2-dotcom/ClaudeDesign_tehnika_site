(function () {
  ...
  const offers = [
    { id: 'KP-0001', number: 'КП-2026-0038', clientId: 'CL-0002', dealId: 'DL-0003',  manager: 'USR-004', amount: 320000,  vatIncluded: true,  createdAt: day(-1),   sentAt: null,      viewedAt: null,     validUntil: day(29),  version: 1 },
    { id: 'KP-0002', number: 'КП-2026-0039', clientId: 'CL-0012', dealId: 'DL-0009',  manager: 'USR-003', amount: 780000,  vatIncluded: true,  createdAt: day(-2),   sentAt: null,      viewedAt: null,     validUntil: day(28),  version: 1 },
    { id: 'KP-0003', number: 'КП-2026-0040', clientId: 'CL-0001', dealId: 'DL-0005',  manager: 'USR-003', amount: 215000,  vatIncluded: false, createdAt: day(-5),   sentAt: day(-4),   viewedAt: null,     validUntil: day(26),  version: 1 },
    { id: 'KP-0004', number: 'КП-2026-0041', clientId: 'CL-0020', dealId: 'DL-0010',  manager: 'USR-004', amount: 1620000, vatIncluded: true,  createdAt: day(-7),   sentAt: day(-6),   viewedAt: null,     validUntil: day(24),  version: 2 },
    { id: 'KP-0005', number: 'КП-2026-0042', clientId: 'CL-0015', dealId: 'DL-0008',  manager: 'USR-006', amount: 560000,  vatIncluded: true,  createdAt: day(-10),  sentAt: day(-9),   viewedAt: null,     validUntil: day(21),  version: 1 },
    { id: 'KP-0006', number: 'КП-2026-0043', clientId: 'CL-0005', dealId: 'DL-0012',  manager: 'USR-005', amount: 2300000, vatIncluded: true,  createdAt: day(-12),  sentAt: day(-11),  viewedAt: null,     validUntil: day(19),  version: 2 },
    { id: 'KP-0007', number: 'КП-2026-0044', clientId: 'CL-0009', dealId: 'DL-0007',  manager: 'USR-004', amount: 475000,  vatIncluded: false, createdAt: day(-14),  sentAt: day(-13),  viewedAt: day(-10), validUntil: day(17),  version: 1 },
    { id: 'KP-0008', number: 'КП-2026-0045', clientId: 'CL-0006', dealId: 'DL-0014',  manager: 'USR-004', amount: 1750000, vatIncluded: true,  createdAt: day(-16),  sentAt: day(-15),  viewedAt: day(-12), validUntil: day(15),  version: 3 },
    { id: 'KP-0009', number: 'КП-2026-0046', clientId: 'CL-0008', dealId: 'DL-0015',  manager: 'USR-005', amount: 980000,  vatIncluded: true,  createdAt: day(-18),  sentAt: day(-17),  viewedAt: day(-14), validUntil: day(13),  version: 2 },
    { id: 'KP-0010', number: 'КП-2026-0047', clientId: 'CL-0009', dealId: 'DL-0018',  manager: 'USR-004', amount: 3100000, vatIncluded: true,  createdAt: day(-62),  sentAt: day(-61),  viewedAt: day(-58), validUntil: day(-32), version: 2 },
    { id: 'KP-0011', number: 'КП-2026-0048', clientId: 'CL-0015', dealId: 'DL-0019',  manager: 'USR-006', amount: 2900000, vatIncluded: true,  createdAt: day(-57),  sentAt: day(-56),  viewedAt: day(-53), validUntil: day(-27), version: 3 },
    { id: 'KP-0012', number: 'КП-2026-0049', clientId: 'CL-0005', dealId: 'DL-0021',  manager: 'USR-003', amount: 560000,  vatIncluded: false, createdAt: day(-42),  sentAt: day(-41),  viewedAt: day(-39), validUntil: day(-12), version: 1 },
  ];
